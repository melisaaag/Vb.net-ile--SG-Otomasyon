...
Public Class Form4
    ...
    Private Sub FillDataSetAndView()
        ...
        Dim objDataAdapter As New OleDbDataAdapter("Select * FROM Kategori_Çapraz", newbagla)
        objDataSet = New DataSet()
        objDataAdapter.Fill(objDataSet, "Kategori_Çapraz")
        objDataView = New DataView(objDataSet.Tables("Kategori_Çapraz"))
